...
class TestYAMLtoRequirement(unittest.TestCase):
    def test_change_specifier_logic(self):
        ...
        for case in version_with_specifier:
            self.assertEqual(
                f"{YAMLListAdapter._change_specifier_logic(case[0])[0]}{YAMLListAdapter._change_specifier_logic(case[0])[1]}",
                case[1],
            )

    def test_yaml_to_requirement(self):
        test_requirements = {
            Requirement("platform;sys_platform == 'win32'"),
            ...
            Requirement(
                "platform-python;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8'"
            ),
            Requirement(
                "platform-python;sys_platform == 'win32' and python_version < '3.8' and python_version > '3.11'"
            ),
            Requirement(
                "platform-python;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8' and python_version > '3.11'"
            ),
            ...
            Requirement(
                "version-platform-python<=0.9.0.2,>0.9.1;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8'"
            ),
            Requirement(
                "version-platform-python<=0.9.0.2;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8'"
            ),
            Requirement(
                "version-platform-python<=0.9.0.2;sys_platform == 'win32' and python_version < '3.8' and python_version > '3.11'"
            ),
            Requirement(
                "version-platform-python<=0.9.0.2,>0.9.1;sys_platform == 'win32' and python_version < '3.8' and python_version > '3.11'"
            ),
            Requirement(
                "version-platform-python<=0.9.0.2,>0.9.1;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8' and python_version > '3.11'"
            ),
            Requirement(
                "version-platform-python<=0.9.0.2;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8' and python_version > '3.11'"
            ),
        }

        self.assertEqual(YAMLListAdapter._yaml_to_requirement("test/test_list.yaml"), test_requirements)

    def test_yaml_to_requirement_exclude(self):
        test_requirements_exclude = {
            Requirement("platform;sys_platform != 'win32'"),
            Requirement("platform;sys_platform != 'win32' or sys_platform != 'linux'"),
            Requirement("version>42"),
            Requirement("version>42,<50"),
            ...
            Requirement(
                "version-platform-python;sys_platform != 'win32' or sys_platform != 'linux' and python_version > '3.8'"
            ),
            Requirement(
                "version-platform-python>=0.9.0.2;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8'"
            ),
            ...
            Requirement(
                "version-platform-python;sys_platform != 'win32' and python_version > '3.8' and python_version < '3.11'"
            ),
            Requirement(
                "version-platform-python>=0.9.0.2,<0.9.1;sys_platform == 'win32' and python_version < '3.8' and python_version > '3.11'"
            ),
            ...
            Requirement(
                "version-platform-python;sys_platform != 'win32' or sys_platform != 'linux' and python_version > '3.8' and python_version < '3.11'"
            ),
            Requirement(
                "version-platform-python>=0.9.0.2;sys_platform == 'win32' or sys_platform == 'linux' and python_version < '3.8' and python_version > '3.11'"
            ),
        ...
        self.assertEqual(
            YAMLListAdapter._yaml_to_requirement("test/test_list.yaml", exclude=True), test_requirements_exclude
        )
